...
class FlavorsTable(tables.DataTable):
    ...
    disk = tables.Column('root_gb', verbose_name=_('Root Disk'))
    ...
    swap = tables.Column(get_swap_size,
                         ...
                         attrs={'data-type': 'size'})
#    flavor_id = tables.Column('flavorid', verbose_name=_('ID'))
    public = tables.Column("is_public",
                           verbose_name=_("Public"),
                           empty_value=False,
                           filters=(filters.yesno, filters.capfirst))
    price = tables.Column("price", verbose_name=_('Price(RMB per DAY)'))
    class Meta:
        name = "flavors"
