  ...
  */
  showFlavorDetails: function() {
    ...
    if (this.selected_flavor) {
      ...
      /* var price = vcpus * 50 + disk * 10 + ram * 20*/
      var price=((parseInt(this.selected_flavor.vcpus)*5000+parseInt(this.selected_flavor.disk)*100+parseInt(this.selected_flavor.ram)*20)*0.0001);
